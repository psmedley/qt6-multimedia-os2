...
QOS2AudioDeviceInfo::QOS2AudioDeviceInfo(const QByteArray &dev, const QString &desc, QAudioDevice::Mode mode)
...
QOS2AudioDeviceInfo::~QOS2AudioDeviceInfo()
{
}

void QOS2AudioDeviceInfo::checkSurround()
{
    surround40 = false;
    surround51 = false;
    surround71 = false;
